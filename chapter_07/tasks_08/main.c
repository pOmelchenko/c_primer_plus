 ...
 * ***********************************************************************
 * </pre>
 * если выбранный вариантс 1 по 4, программа должна запрашивать количество отработанных часов. Программа должна 
 * повторяться до тех пор, пока не будет выхран вариант 5. При вводе чего-то отличного от вариантов 1-5 программа 
