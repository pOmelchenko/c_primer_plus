 ...
 *
 * @details Обобщите функцию <code>to_binary()</code> из листинга 9ю8 до функции <code>to_base_n()</code>, которая
 * принимает второй аргумент в жиапазоне от 2 о 10. Она должна выводить число, переданное в первом аргументе, в системе
